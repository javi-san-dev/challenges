...
export const LightThemeIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const CheckIcon = ({ size }: { size: string }) => {
	return (
		<svg
			...
			fill="currentColor"
		>
			<path d="M378-240.26 148.26-470l48.98-48.98L378-338.22l383.76-383.76L810.74-673 378-240.26Z" />
		</svg>
	);
};

export const CheckedIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const RoundedErrorIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const ClockIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const TerminalIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
			...
			width={size}
		>
			<path d="M172.309-180.001q-30.308 0-51.308-21t-21-51.308v-455.382q0-30.308 21-51.308t51.308-21h615.382q30.308 0 51.308 21t21 51.308v455.382q0 30.308-21 51.308t-51.308 21H172.309Zm0-59.999h615.382q4.616 0 8.463-3.846 3.846-3.847 3.846-8.463V-640H160v387.691q0 4.616 3.846 8.463 3.847 3.846 8.463 3.846ZM300-294.232 258.232-336l103-104-104-104L300-585.768 445.768-440 300-294.232Zm190.001 4.231v-59.998h219.998v59.998H490.001Z" />
		</svg>
	);
};

export const CodeIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const ReloadIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const CopyIcon = ({ size }: { size: string }) => {
	return (
		<svg
			aria-hidden="true"
			fill="none"
...
export const FullScreenIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const HelpIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const DownIcon = ({ strokeWidth = 1.5, ...otherProps }) => (
	<svg
		aria-hidden="true"
		fill="none"
		focusable="false"
...
export const ErrorIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export function PythonIcon({ size }: { size: string }) {
	return (
		<svg
			role="img"
			aria-label="svgImage"
		...
		>
			...
			>
				{" "}
				<stop offset={0} style={{ stopColor: "#387EB8" }} /> <stop offset={1} style={{ stopColor: "#366994" }} />
			</linearGradient>
			<path
				fill="url(#SVGID_1_)"
			...
			>
				{" "}
				<stop offset={0} style={{ stopColor: "#FFE052" }} /> <stop offset={1} style={{ stopColor: "#FFC331" }} />
			</linearGradient>
			<path
				fill="url(#SVGID_2_)"
...
export function JavaIcon({ size }: { size: string }) {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const ErrorConsole = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
...
export const GoogleIcon = ({ size }: { size: string }) => {
	return (
		<svg
			role="img"
			aria-label="svgImage"
